...
<div class="container">
    <div class="row">
       ...
       <div class="text-center">
           <a href="${pageContext.request.contextPath}/notice/edit?no_no=${b.no_no}" class="btn btn-warning">공지사항 수정</a>
       </div>
	</div>
</div>
<br><br>
    ...
    <div class="row">
    	<form action="${pageContext.request.contextPath}/notice/comment/write?no_no=${b.no_no}" method="post">
    	    <div class="form-group">
		        ...
		        <textarea class="form-control" placeholder="댓글 작성" name="no_comm_content" maxlength="2048" style="height:100px"></textarea>
		    </div>
		    <div class="text-center">
