...
<%@ include file="/inc/header.jsp" %>
		...
		<form action="${pageContext.request.contextPath}/art_info/edit/art_no=${dto.art_no}" method="post" enctype="multipart/form-data" id="form1">
			<fieldset>
