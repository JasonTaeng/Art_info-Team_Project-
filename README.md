...
- ERD 설계
- 프론트 컨트롤러 설계
- 관리자 회원관리 기능 및 게시판 기능 개발


4. 느낀점: 첫 팀프로젝트를 수행해보니 설계와 팀원들간의 의사소통이 중요한 것을 실감했습니다. 특히, 각자의 파트가 유기적으로 공통되는 부분에서 의사의 일치와 소통이 중요하다고 깨달았습니다. 이번 팀 프로젝트를 통해 미흡했던 점은 다음과 같습니다.
   - 각자 이해한 내용이 맞는지 확인하기
   - 진행상황을 중간 공유하기
   - 유지 보수를 위한 설계 밑 코드의 통일성

5. 제작기간 / 참여인원: 2023.05.01 ~ 2023.06.07(약 5주) / 4명
